...
`timescale 1 ns / 1 ps
	...
	(
        ...
        output reg [0:0]                        ht_output_client,
...
*/
	      ...
	      begin
	       // state transition
	        case (mst_exec_state_wr)
	          ...
	          FIND: begin
	             if (axi_rready && empty_key_rd && ((ht_wr_op == UPDATE_OP) || (ht_wr_op == DELETE_OP) || (ht_wr_op == READ_OP)) && (read_index == MEMORY_ROW_SIZE - 2)) begin  // non-existent key on read/update/delete
	                 mst_exec_state_wr <= IDLE;
	             end else if (axi_rready && ((correct_key_wr && ((ht_wr_op == UPDATE_OP) || (ht_wr_op == DELETE_OP)) && (read_index == MEMORY_ROW_SIZE - 2)) ||
	               ...
	               read_issued <= 1'b0;
	               read_index <= 4'b0;
	             end else if (axi_rready && read_index == MEMORY_ROW_SIZE - 2 && ((!correct_key_wr && (ht_wr_op == UPDATE_OP || ht_wr_op == DELETE_OP)) || 
    ...
    */
	...
	//Data Comparison
	  ...
	  begin
	    if (M_AXI_ARESETN == 0)
	       correct_key_rd <= 1'b1;
	    else if ((axi_rready && read_index == MEMORY_ROW_SIZE - 2) | ht_init_wr | ht_init_rd)
	       correct_key_rd <= 1'b1;
	...
	*/
	...
	reg [0:0]                       client_buffer [0:BUFFER_SIZE-1];
	...
	always @(posedge M_AXI_ACLK) begin
	   ...
	   if (ht_input_valid == 1) begin
	       ...
	       if (buffer_status[0] == EMPTY) begin
	           ...
	           client_buffer[0] <= ht_input_client;
	           ...
	           client_buffer[1] <= ht_input_client;
	           ...
	           client_buffer[2] <= ht_input_client;
	           ...
	           client_buffer[3] <= ht_input_client;
	           ...
	           client_buffer[4] <= ht_input_client;
	           ...
	           client_buffer[5] <= ht_input_client;
	           ...
	           client_buffer[6] <= ht_input_client;
	           ...
	           client_buffer[7] <= ht_input_client;
	           ...
	           client_buffer[8] <= ht_input_client;
	           ...
	           client_buffer[9] <= ht_input_client;
	           ...
	           client_buffer[10] <= ht_input_client;
	           ...
	           client_buffer[11] <= ht_input_client;
	           ...
	           client_buffer[12] <= ht_input_client;
	           ...
	           client_buffer[13] <= ht_input_client;
	           ...
	           client_buffer[14] <= ht_input_client;
	           ...
	           client_buffer[15] <= ht_input_client;
	           ...
	           client_buffer[16] <= ht_input_client;
	           ...
	           client_buffer[17] <= ht_input_client;
	           ...
	           client_buffer[18] <= ht_input_client;
	           ...
	           client_buffer[19] <= ht_input_client;
	           ...
	           client_buffer[20] <= ht_input_client;
	           ...
	           client_buffer[21] <= ht_input_client;
	           ...
	           client_buffer[22] <= ht_input_client;
	           ...
	           client_buffer[23] <= ht_input_client;
	           ...
	           client_buffer[24] <= ht_input_client;
	           ...
	           client_buffer[25] <= ht_input_client;
	           ...
	           client_buffer[26] <= ht_input_client;
	           ...
	           client_buffer[27] <= ht_input_client;
	           ...
	           client_buffer[28] <= ht_input_client;
	           ...
	           client_buffer[29] <= ht_input_client;
	           ...
	           client_buffer[30] <= ht_input_client;
	           ...
	           client_buffer[31] <= ht_input_client;
	    ...
	    if (M_AXI_RVALID && axi_rready) begin
	       for (i = 0; i < BUFFER_SIZE; i = i + 1) begin
	           if (buffer_status[i] == EXEC_RD) begin
	               if (empty_key_rd && (read_index == MEMORY_ROW_SIZE - 2)) begin
	                   data_buffer[i] <= 0;
        ...
        //if (M_AXI_BVALID && axi_bready) begin
	       for (i = 0; i < BUFFER_SIZE; i = i + 1) begin
	           if (buffer_status[i] == EXEC_WR) begin
	               if (empty_key_rd && ((ht_wr_op == UPDATE_OP) || (ht_wr_op == DELETE_OP)) && (read_index == MEMORY_ROW_SIZE - 2))
	                   buffer_status[i] <= RET_WR;
	               else if (write_index == MEMORY_ROW_SIZE && M_AXI_BVALID && axi_bready)
	                   buffer_status[i] <= RET_WR;
	           end
	       end
	    //end
        ...
        if (ht_output_ready) begin
            for (i = 0; i < BUFFER_SIZE; i = i + 1) begin
                if (buffer_status[i] == RET_RD) begin
                    ...
                    ht_output_client <= client_buffer[i];
                    ht_output_valid <= 1;
                    buffer_status[i] <= EMPTY;

...
HD_PWD='W:/ECE532/project/hash_server/hash_server.runs/design_1_hash_table_mgr_mig_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log design_1_hash_table_mgr_mig_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source design_1_hash_table_mgr_mig_0_0.tcl

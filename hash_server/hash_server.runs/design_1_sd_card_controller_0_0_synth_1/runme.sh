...
HD_PWD='C:/Users/jiangja5/hash_server/hash_server.runs/design_1_sd_card_controller_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log design_1_sd_card_controller_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source design_1_sd_card_controller_0_0.tcl

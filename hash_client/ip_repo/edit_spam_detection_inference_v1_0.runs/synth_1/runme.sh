...
HD_PWD='C:/Users/Owner/ECE532/project/Client_FPGA/Feb_27_proj/ip_repo/edit_spam_detection_inference_v1_0.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log spam_detection_inference_v1_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source spam_detection_inference_v1_0.tcl

...
HD_PWD='C:/Users/Owner/ECE532/project/Client_FPGA/Feb_27_proj/client_proj/client_proj.runs/design_1_spam_detection_infer_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log design_1_spam_detection_infer_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source design_1_spam_detection_infer_0_0.tcl
